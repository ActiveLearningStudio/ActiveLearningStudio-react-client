...
const LayoutCard = ({ activity, setActiveType, setModalShow, setCurrentActivity, image, text, color, className, onClick = () => { }, importImg, btnTextOne, btnTextTwo }) => {
			...
			{btnTextOne && (
				<div className="card-btn">
					...
					<button
						...
						className="btn">{btnTextTwo}</button>
				</div>
			)}
		</div>
	);
