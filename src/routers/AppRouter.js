...
const C2EPage = loadable(() => import("../containers/C2E"));
const C2EEditPage = loadable(() => import("../containers/C2eEdit"));
let intialLoad = 0;
  ...
  return (
    <Router history={history}>
      <Switch>
        ...
        <OpenRoute
          exact
          path="/org/:organization/terms-policy-content/:content"
          component={termsPolicyContent}
        />
        <OpenRoute
          exact
          path="/canvas-lti-sso"
        ...
        <OpenRoute
          exact
          path="/msteams/launch/activity/:activityId/class/:classId/assignment/:assignmentId"
          component={MsTeamsActivityPage}
        />
        <OpenRoute
          exact
        ...
        <OpenRoute
          exact
          path="/msteam/summary/:classId/:activityId/:submissionId"
          component={MsTeamSummaryPage}
        />
        <OpenRoute
          exact
        ...
        <OpenRoute
          exact
          path="/msteams/callback"
          component={MsTeamsCallBack}
        />
              ...
              <div className="main-content-wrapper">
                <div
                  className={`sidebar-wrapper ${
                    hideShowSideBar == true ? "hide-sidebar" : ""
                  }`}
                  style={{ width: isMsTeam ? "224px" : "136px" }}
                >
                  {isMsTeam === true ? (
                    <SidebarMsteam />
                  ) : (
                ...
                <Switch>
                  ...
                  <PrivateRoute
                    exact
                    path="/org/:organization/activities"
                    component={VideoPage}
                    overview
                    activities
                  />
                  <PrivateRoute
                    exact
                    path="/org/:organization/instance-admin"
                    showSSO
                    component={AdminPanel}
                  />
                  <PrivateRoute
                    exact
                    path="/org/:organization/library"
                    showSSO
                    component={Library}
                  />
                  ...
                  <PrivateRoute
                    exact
                    path="/org/:organization/c2e"
                    component={C2EPage}
                  />
                  <PrivateRoute
                    exact
                    path="/org/:organization/c2e/:projectId"
                    component={C2EEditPage}
                  />
                  {/* <PrivateRoute
                    exact
                  ...
                  <PrivateRoute
                    exact
                    path="/org/:organization/record-video"
                    component={RecordVideoPage}
                  />

                  <Redirect
                    to={`/org/${
                      SelectedOrganization || "currikistudio"
                    }/activities`}
                  />
                </Switch>
                <Footer />
