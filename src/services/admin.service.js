...
// project
const getAllProject = (subOrgId, page, size, authorId, createdFrom, createdTo, updatedFrom, updatedTo, shared, index) =>
  httpService
...
const getAllExportedProject = (page, size, query = '') =>
  httpService
...
const getAllProjectSearch = (subOrgId, page, search, size) =>
  httpService
...
const getLmsProject = (subOrgId, page) =>
  httpService
...
const getDefaultSso = (orgId, page) =>
  httpService
...
const getLtiTools = (subOrgId, page) =>
  httpService
...
const getLtiToolsOrderBy = (subOrgId, column, orderBy, page) =>
  httpService
...
const getSubjects = (page, column, orderBy) =>
  httpService
...
const getEducationLevel = (page, column, orderBy) =>
  httpService
...
const createEducationLevel = (values) =>
  httpService
...
const updateEducationLevel = (id, values) =>
  httpService
...
const getAuthorTag = (page, column, orderBy) =>
  httpService
...
const updateAuthorTag = (id, values) =>
  httpService
