...
const browse = (params) =>
  httpService
    .post(`/${apiVersion}/go/lms/projects`, { ...params })
    .then(({ data }) => data)
...
const getLtiSummary = (actor, activity) =>
  httpService
    .post(`/${apiVersion}/outcome/summary`, { actor, activity })
    .then(({ data }) => data)
    .catch((error) => {
...
const passLtiCourseDetails = (params) =>
  httpService
    .post(`/${apiVersion}/go/passLtiCourseDetails`, { ...params })
    .then(({ data }) => data)
    .catch((err) => Promise.reject(err.response.data));
