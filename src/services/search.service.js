...
const googleClassShare = (projectId, courseId, token, OrgId) => httpService
...
const googleClassPublishPlaylist = (projectId, courseId, topicId, playlistId, token, OrgId) => httpService
...
const googleClassPublishActivity = (projectId, courseId, topicId, playlistId, activityId, token, OrgId) => httpService
...
const googleClassPublishIndependentActivity = (courseId, topicId, activityId, token, OrgId) => httpService
