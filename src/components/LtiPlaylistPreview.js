        ...
        <div className="slider-hover-section">
          ...
          <div className="hover-control-caption pointer-cursor">
            ...
            >
              <div
                style={{
                  backgroundImage: previousResource.metadata.thumb_url
                    ? previousResource.metadata.thumb_url.includes("pexels.com")
                      ? "url(" + previousResource.metadata.thumb_url + ")"
                      : "url(" +
        ...
        <div className="slider-hover-section">
          ...
          <div className="hover-control-caption pointer-cursor">
            ...
            >
              <div
                style={{
                  backgroundImage: nextResource.metadata.thumb_url
                    ? nextResource.metadata.thumb_url.includes("pexels.com")
                      ? "url(" + nextResource.metadata.thumb_url + ")"
                      : "url(" +
                        global.config.laravelAPIUrl +
