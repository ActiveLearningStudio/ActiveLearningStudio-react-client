                              ...
                              <div className="thumb">
                                <img
                                  src={
                                    ...
                                    props.resource.editResource.metadata
                                      .thumb_url
                                  }
                                />
                              </div>
...
const mapDispatchToProps = (dispatch) => ({
  ...
  onSubmitDescribeActivityAction: (metadata, activityid) =>
    dispatch(onSubmitDescribeActivityAction(metadata, activityid)),
...
const mapStateToProps = (state) => {
  return {
    ...
    initialValues: {
      ...
      metaEducationLevels:
        state.resource.editResource.metadata.educationlevelid,
    },
  };
};
