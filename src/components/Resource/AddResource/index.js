                        ...
                        <div className="modal-body">
                            <div className='row'>
                                <div className="col-md-12">
                                    ...
                                    {props.resource.isResourceActivityType && !props.editResourcePopup ?
                                        <ResourceActivityType {...props} />
                                        : null
                                    }
                                    {props.resource.isResourceSelectActivity && !props.editResourcePopup ?
                                        <ResourceSelectActivity  {...props} />
                                        : null
                                    }
                                    {props.resource.isResourceDescribeActivity && !props.editResourcePopup ?
                                        <ResourceDescribeActivity selectResourceDescribeActivity={props.showResourceDescribeActivity} />
                                        : null
                                    }
                                    {props.resource.isResourceActivityBuild && !props.editResourcePopup ?
