  ...
  submitResource(event) {
    ...
    if (0) {
      let payload = {
        ...
        h5pFile: this.state.h5pFile,
      };
      this.props.handleEditResourceSubmit(
        this.props.match.params.playlistid,
        this.props.resource.newResource.activity.h5pLib,
        this.props.resource.newResource.activity.h5pLibType,
        payload
      );
    } else if (
      this.state.submitAction === "upload" &&
      this.state.h5pFile === null
    ) {
    } else if (
      this.state.submitAction === "upload" &&
      this.state.h5pFile !== null
      ...
      if (file_extension !== "h5p") {
        ...
        this.props.handleCreateResourceSubmit(
          this.props.match.params.playlistid,
          this.props.resource.newResource.activity.h5pLib,
          this.props.resource.newResource.activity.h5pLibType,
          payload,
          this.props.resource.newResource.metadata
        );
      }
        ...
        >
          {this.props.editResourcePopup ? (
            <>
              ...
              <input
                ...
                value={this.props.h5pLib}
              />
              <input
                type="hidden"
                name="parameters"
                id="laravel-h5p-parameters"
                value={this.props.h5pParams}
              />
            </>
          ) : (
            <>
          ...
          <fieldset>
            <div id="laravel-h5p-create" className="form-group ">
              <label for="inputParameters" className="control-label col-md-3">
                &nbsp;
              </label>
            ...
            <div className="form-group ">
              <label for="inputAction" className="control-label col-md-3">
                Method
              </label>
              <div className="col-md-6">
                <label className="radio-inline">
                  <input
                    ...
                    checked={this.state.submitAction === "upload"}
                ...
                <label className="radio-inline">
                  <input
                    ...
                    value="create"
                    className="laravel-h5p-type"
                    checked={this.state.submitAction === "create"}
                    onChange={this.onSubmitActionRadioChange}
                  />
                  Create
                </label>
