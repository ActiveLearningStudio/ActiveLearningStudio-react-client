...
import './CreatePlaylistPopup.scss'
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-body">
                        <input type="text" name="playlistName" className="playlistName form-control" autoFocus="on" autoComplete="off" placeholder="Enter playlist title..." onChange={props.onPlaylistTitleChange} />
                    </div>
