...
function Sidebar(props) {
  ...
  return (
    <aside className="sidebar-all">
      ...
      {permission?.['Independent Activity']?.includes('independent-activity:view-author') && (
        <>
          <Link to={`/org/${allState.organization.currentOrganization?.domain}/library`} onClick={() => {}}>
            <div className={active === `/org/${allState.organization.currentOrganization?.domain}/library` ? 'row-sidebar activeLink' : 'row-sidebar'}>
