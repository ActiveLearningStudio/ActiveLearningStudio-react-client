  ...
  return (
    <aside className="sidebar-all">
        ...
        <>
          ...
          >
            <div
              className={
                active ===
                `/org/${allState.organization.currentOrganization?.domain}/activities`
        ...
        <>
          ...
          >
            <div
              className={
                active ===
                `/org/${allState.organization.currentOrganization?.domain}`
                  ? "row-sidebar activeLink"
                  : "row-sidebar"
              }
            >
        ...
        <>
          ...
          >
            <div
              className={
                active ===
                `/org/${allState.organization.currentOrganization?.domain}/video`
                  ? "row-sidebar activeLink"
                  : "row-sidebar"
              }
            >
      ...
      {permission?.["Record a Video"]?.includes(
        ...
        >
          <div
            className={
              active ===
              `/org/${allState.organization.currentOrganization?.domain}/record-video`
                ? "row-sidebar activeLink"
                : "row-sidebar"
            }
          >
      ...
      {permission?.["Independent Activity"]?.includes(
        ...
        <>
          <Link
            to={`/org/${allState.organization.currentOrganization?.domain}/search`}
            onClick={() => {}}
          >
            <div
              className={
                active ===
                `/org/${allState.organization.currentOrganization?.domain}/search`
                  ? "row-sidebar activeLink"
                  : "row-sidebar"
              }
            >
        ...
        <>
          ...
          >
            <div
              className={
                active ===
                `/org/${allState.organization.currentOrganization?.domain}/admin`
                  ? " row-sidebar activeLink"
                  : "row-sidebar"
              }
            >
          ...
          <>
            ...
            >
              <div
                className={
                  active ===
                  `/org/${allState.organization.currentOrganization?.domain}/instance-admin`
                    ? "row-sidebar activeLink"
                    : "row-sidebar"
                }
              >
