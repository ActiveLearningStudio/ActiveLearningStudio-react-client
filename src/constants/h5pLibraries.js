const h5pLibraries = [
        ...
        },
        {
            ...
            type: 'h5p',
            icon: '/images/h5p-icons/audio-recorder.png',
            overlayIcon: '/images/h5p-icons/audio-recorder.png',
        ...
        },
        {
            ...
            type: 'h5p',
            icon: '/images/h5p-icons/dictation.png',
            overlayIcon: '/images/h5p-icons/dictation.png',
        ...
        },
        {
            ...
            type: 'h5p',
            icon: '/images/h5p-icons/image-slider.png',
            overlayIcon: '/images/h5p-icons/image-slider.png',
        ...
        },
        {
            ...
            type: 'h5p',
            icon: '/images/h5p-icons/personality-quiz.png',
            overlayIcon: '/images/h5p-icons/personality-quiz.png',
