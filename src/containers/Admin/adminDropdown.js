                ...
                <Dropdown.Item
                  onClick={() => {
                    if (subType === "Activity Items") {
                      ...
                      dispatch(
                        setActiveAdminForm("edit_activity_type")
                      );
                    }
                  }}
                >
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        const response = adminService.deleteSubject(
                          activeOrganization?.id,
                          row?.id
                        );
                        response
              ...
              <>
                <Dropdown.Item
                  onClick={() => {
                    ...
                    dispatch(
                      setActiveAdminForm("edit_education_level")
                    );
                  }}
                >
                  {/* <img src={Edit} alt="Preview" className="menue-img" /> */}
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        const response = adminService.deleteAuthorTag(
                          activeOrganization?.id,
                          row?.id
                        );
                        response
              ...
              <>
                <Dropdown.Item
                  onClick={() => {
                    ...
                    dispatch(
                      setActiveAdminForm("edit_activity_layout")
                    );
                  }}
                >
                  <EditDpDnMdSvg
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        const response = adminService.deleteActivityLayout(
                          activeOrganization?.id,
                          row?.id
                        );
                        response
                          .then((res) => {
                            Swal.fire({
                              icon: "success",
                              text:
                                "Activity layout deleted successfully",
                              confirmButtonText: "Close",
                              customClass: {
                                confirmButton:
                                  "confirmation-close-btn",
            ...
            <>
              ...
              {permission?.Organization.includes(
                ...
                auth?.user?.id !== user.id && (
                  <Dropdown.Item
                    onClick={() => dispatch(showRemoveUser(user))}
                  >
                    <RemoveSmSvg
                      primaryColor={primaryColor}
                      className="menue-img"
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        const response = adminService.deleteLtiTool(
                          activeOrganization?.id,
                          row?.id
                        );
                        response
              ...
              {permission?.Organization.includes(
                ...
                <Dropdown.Item
                  onClick={() => {
                    ...
                    dispatch(setActiveAdminForm("edit_publisher"));
                  }}
                >
                  <EditDpDnMdSvg
                    primaryColor={primaryColor}
                ...
                <Dropdown.Item
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        Swal.fire({
                          title: `C2E Publisher's Config Key`,
                          icon: "info",
                          text: `Deleting C2E Publisher's Config Key...`,
                          allowOutsideClick: false,
                          onBeforeOpen: () => {
                            Swal.showLoading();
                          },
                        ...
                        const response = adminService.removePublisherList(
                          activeOrganization?.id,
                          row?.id
                        );
                        response
                          .then((res) => {
                            Swal.fire({
                              icon: "success",
                              text: "Publisher's Config Key deleted!",
                              confirmButtonText: "Close",
                              customClass: {
                                confirmButton:
                                  "confirmation-close-btn",
            ...
            <>
              <Dropdown.Item
                onClick={() => {
                  ...
                  dispatch(
                    getTeamPermission(activeOrganization?.id, row?.id)
                  );
                }}
              >
                <EditDpDnMdSvg
              ...
              <Dropdown.Item
                onClick={() => {
                  Swal.fire({
                    ...
                    icon: "warning",
                    html:
                      "<p>All Projects and associated data will be deleted. You won&apos;t be able to undo this.</p>",
                    showDenyButton: true,
                    showCancelButton: true,
                    confirmButtonText: "Delete it",
                    denyButtonText: "No",
