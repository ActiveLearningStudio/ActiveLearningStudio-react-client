                ...
                <>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <path
                        d="M5.66687 10.5065L9.0002 7.17318L5.66687 3.83984"
                        stroke={primaryColor}
                        strokeWidth="1.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            <>
              ...
              <Dropdown.Item
                onClick={() => {
                  ...
                  const protocol = `${window.location.href.split("/")[0]}//`;
                  const url = `${protocol}${window.location.host}/project/${row.title}/shared?type=ind`;
                  ...
                  onClick={() => {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        if (subType === "Activity Items") {
                          resultDel = await dispatch(
                            deleteActivityItem(activeOrganization?.id, row.id)
                          );
                          dispatch(loadResourceItemAction(row.id));
                        } else {
                          resultDel = await dispatch(
                            deleteActivityType(activeOrganization?.id, row.id)
                          );
                    ...
                    if (result.isConfirmed) {
                      ...
                      response
                        .then((res) => {
                          ...
                          dispatch(
                            getSubjects(activeOrganization?.id, activePage || 1)
                          );
                        })
                        .catch((err) => console.log(err));
                    }
                    ...
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        const result = await dispatch(
                          deleteBrightCove(activeOrganization?.id, row?.id)
                        );
                        if (result.message) {
                          Swal.fire({
                            icon: "success",
