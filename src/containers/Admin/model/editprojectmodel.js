...
import PreviewResourcePage from "../../Playlists/PreviewResourcePage";
import CreatePlaylistPopup from "../../Playlists/CreatePlaylistPopup";
...
const EditProjectModel = (props) => {
  ...
  const handleCreatePlaylistSubmit = async () => {
    ...
    if (!/^ *$/.test(title) && title) {
      try {
        await createPlaylist(projectID, title);
        // history.push(
  ...
  const onDragEnd = (e) => {
    ...
    if (e.type === "resource") {
      ...
      reorderPlaylists(projectID, orgPlaylists, pLists);
    }
  };
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        {/* <Modal.Title id="contained-modal-title-vcenter">
          <p className="modelbox-container-text">
            You are currently viewing Thumbnails form Category. You can search
            other thumbnails below as well.
          </p>
        </Modal.Title> */}
      </Modal.Header>
      ...
      <Modal.Body>
        <>
          <div
            // className="content-wrapper content-wrapper-model"
                          ...
                          <div className="project-share-previews">
                            <div className="project-preview">
                              <Link
                                ...
                                to={`/org/${organization.currentOrganization?.domain}/project/${projectID}/preview`}
                              >
