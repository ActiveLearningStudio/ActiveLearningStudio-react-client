    ...
    <div className="create-form lms-admin-form">
      <Formik
        initialValues={{
          ...
          tool_custom_parameter: editMode
            ? activeEdit?.tool_custom_parameter
            : "",
          tool_url: editMode ? activeEdit?.tool_url : "",
          tool_content_selection_url: editMode
            ? activeEdit?.tool_content_selection_url
            : "",
                ...
                <div>
                  ...
                  <div className="form-group-create">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      value={values.tool_consumer_key}
                    />
                    <div className="error">
                      {errors.tool_consumer_key &&
                        touched.tool_consumer_key &&
                        errors.tool_consumer_key}
                    </div>
                  </div>
                  ...
                  <div className="form-group-create">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      value={values.tool_secret_key}
                    />
                    <div className="error">
                      {errors.tool_secret_key &&
                        touched.tool_secret_key &&
                        errors.tool_secret_key}
                    </div>
                  </div>
                  ...
                  <div className="form-group-create">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      value={values.tool_custom_parameter}
                    />
                    <div className="error">
                      {errors.tool_custom_parameter &&
                        touched.tool_custom_parameter &&
                        errors.tool_custom_parameter}
                    </div>
                  </div>
                  ...
                  <div className="form-group-create">
                    ...
                    <input
                      type="text"
                      name="tool_content_selection_url"
                      onChange={handleChange}
                      onBlur={handleBlur}
                      value={values.tool_content_selection_url}
                    />
                    <div className="error">
                      {errors.tool_content_selection_url &&
                        touched.tool_content_selection_url &&
                        errors.tool_content_selection_url}
                    </div>
                  </div>
