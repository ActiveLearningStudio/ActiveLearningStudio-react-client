    ...
    <div className="create-form">
      <Formik
        initialValues={{
          ...
          primary_color: editMode ? activeEdit?.branding.primary_color : '#084892',
          secondary_color: editMode ? activeEdit?.branding.secondary_color : '#F8AF2C',
          tertiary_color: editMode ? activeEdit?.branding.tertiary_color : '#515151',
