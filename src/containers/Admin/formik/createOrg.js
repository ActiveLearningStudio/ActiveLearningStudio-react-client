...
export default function CreateOrg(prop) {
  ...
  const [saveAddOwnprimaryColor, setSaveAddOwnprimaryColor] = useState(
    "#084892"
  );
  const [saveAddOwnsecondaryColor, setSaveAddOwnsecondaryColor] = useState(
    "#F8AF2C"
  );
  const [saveAddOwnteritaryColor, setSaveAddOwnteritaryColor] = useState(
    "#515151"
  );

  const [saveAddOwnprimaryFont, setSaveAddOwnprimaryFont] = useState("rubic");
  const [saveAddOwnsecondaryFont, setSaveAddOwnsecondaryFont] = useState(
    "Open Sans"
  );
  useEffect(() => {
    if (editMode) {
                  ...
                  <div className="tab-inner-section mb-16">
                    <div className="tab_inner_header">
                      ...
                      >
                        ...
                        >
                          <path
                            d="M13.0001 1.63672V4.90931H9.72754"
                            stroke={primaryColor}
                            stroke-width="1.5"
                          ...
                          >
                            <div>
                              <img
                                src={
                                  imageActive
                                    ? imageActive.includes("dev.currikistudio")
                                      ? imageActive
