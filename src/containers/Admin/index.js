...
function AdminPanel({ showSSO }) {
  ...
  useEffect(() => {
    if (activeOrganization?.id) {
      dispatch(ltiToolType(activeOrganization?.id));
    }
  }, [activeOrganization]);
  return (
    <div className="admin-panel">
      {true ? (
        <>
          <div
            className={`content-wrapper content-wrapper-admin ${
            ...
            <div className="form-new-popup-admin">
              ...
              <div className="inner-form-content">
                {activeForm === "add_subject" ? (
                  ...
                  <CreateSubject editMode />
                )}
              </div>
            </div>
          )}
          {(activeForm === "add_education_level" ||
            activeForm === "edit_education_level") && (
            <div className="form-new-popup-admin">
              <FontAwesomeIcon
                icon="times"
                className="cross-all-pop"
              ...
              <div className="inner-form-content">
                {activeForm === "add_education_level" ? (
                  ...
                  <CreateEducationLevel editMode />
                )}
              </div>
            </div>
          )}
          {(activeForm === "add_author_tag" ||
            activeForm === "edit_author_tag") && (
            <div className="form-new-popup-admin">
              <FontAwesomeIcon
                icon="times"
                className="cross-all-pop"
          ...
          {(activeForm === "add_activity_layout" ||
            activeForm === "edit_activity_layout") && (
            <div className="form-new-popup-admin">
              <FontAwesomeIcon
                icon="times"
                className="cross-all-pop"
