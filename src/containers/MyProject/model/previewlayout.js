...
const PreviewLayoutModel = (props) => {
  ...
  const [
    ...
    setInsertActivityCallback,
  ] = useState(null);
  const [
    insertActivityLibraries,
    setInsertActivityLibraries,
  ] = useState(null);
  const [
  ...
  const [
    ...
    setH5PImageUploadDialogDetails,
  ] = useState(null);
  ...
  const handleExistingActivitySearchEvent = (e) => {
    ...
    setInsertActivityCallback(() => (data) =>
    ...
    <>
              ...
              <>
                ...
                {editVideo && (
                  <H5PEditor
                    h5pParams={edith5p}
                    h5pLib={
                      editVideo.h5p_content.library.name +
                      " " +
                      editVideo.h5p_content.library.major_version +
                      "." +
                      editVideo.h5p_content.library.minor_version
                    }
                    hide={props.onHide}
                    type={type}
                    formData={props?.formData}
              ...
              <>
                            ...
                            <>
                              <Tabs
                                text={
                                  editVideo
                                    ? "2. Describe video"
                                    : "2. Describe and  create activity"
                                }
                                className="ml-10"
                                tabActive={true}
                              />
                ...
                <H5PEditor
                  ...
                  h5pParams={
                    edith5p
                      ? edith5p
                      : `{\"params\":{},\"metadata\":{"title":"${props?.formData?.title}"}}`
                  }
                  hide={props.onHide}
      ...
      {showActivitySearch && (
        <ExistingActivitySearchContainer
          ...
          closeModal={() =>
            handleExistingActivitySearchEvent("close")
          }
        />
      )}
      {showH5PImageUploadDialog && (
