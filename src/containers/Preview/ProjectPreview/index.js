          ...
          <div className="add-btn-activity">
            <button
              ...
              onClick={() => {
                ...
                history.push(`/org/${organization.activeOrganization?.domain}/project/${playlist.project_id}/playlist/${playlist.id}/activity/create`);
              }}
            >
          ...
          <div className="container">
            <div className="scene flex-wrap">
              <div className="scene-img">
                <div id="content" />
                <Link to={`/org/${organization.activeOrganization?.domain}/project/${currentProject.id}`}>
                    ...
                    <div className="title_lg check">
                      ...
                      <div className="configuration">
                        <DropdownProject
                          ...
                          previewMode
                        />
                        <Link to={`/org/${organization.activeOrganization?.domain}`} onClick={history.goBack} className="go-back-button-preview">
