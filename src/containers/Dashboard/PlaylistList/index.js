  ...
  return (
    <div className="dashboard-project-list">
      {shared ? (
        <Alert variant="info">
          A list of your
          <strong>shared</strong> shared playlists.
        </Alert>
      ) : (
            ...
            playlists.map((playlist) => (
              <div className="row playlist m-2 p-2">
                <div className="col">
                  ...
                  <div className="row">
                    <div className="col">
                      {playlist.activities.length === 0 && <Alert variant="info">This playlist is empty.</Alert>}
                              ...
                              <Card className="activity-card">
                                {activity.thumb_url ? (
                                  <img
                                    ...
                                    src={!activity.thumb_url.includes('/storage/') ? activity.thumb_url : global.config.resourceUrl + activity.thumb_url}
                                    alt=""
                                  />
                                ) : (
                                  <img
