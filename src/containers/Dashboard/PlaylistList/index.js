...
function PlaylistList(props) {
  ...
  return (
    <div className="dashboard-project-list">
      { shared ? 
          <Alert variant='info'>A list of your <strong>shared</strong> shared playlists.</Alert>
        :
                    ...
                    <div className="col">
                        <div className="row">
                            ...
                            <div className="col-1 text-right">
                                <a href={`/project/${playlist.project_id}`} target="_blank" >
                                        ...
                                        {playlist.activities.map(activity => (
                                            <li className="activity p-2">
                                                <Card className="activity-card">
                                                    {activity.thumb_url ? (
                                                        <img className="card-img-top" src={activity.thumb_url.includes('pexels.com') ? activity.thumb_url : global.config.resourceUrl + activity.thumb_url }/>

                                                    ) : (
                                                        <img className="card-img-top" src='https://images.pexels.com/photos/593158/pexels-photo-593158.jpeg?auto=compress&amp;cs=tinysrgb&amp;dpr=1&amp;fit=crop&amp;h=200&amp;w=280'/>
                                                    )}
                                                    <Card.Body>
