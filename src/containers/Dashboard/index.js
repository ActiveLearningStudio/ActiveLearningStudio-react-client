            ...
            <div className="row metrics-counters">
              <div className="col dashboard-panel m-3">
                ...
                <div className="row text-center">
                  <div className="col">
                    <span className="" onClick={()=> handleCounterClick('project-count')}>{metrics.project_count}</span>
                    <label>COUNT</label>
                  </div>
                  <div className="col">
                  ...
                  <div className="col">
                    <span onClick={()=> handleCounterClick('project-shared-count')}>{metrics.project_shares}</span>
                    <label>SHARED</label>
                  </div>
                </div>
              </div>
