    ...
    return (
      <Dropdown className="pull-right playlist-dropdown check">
        ...
        <Dropdown.Menu>
          ...
          {(Object.keys(teamPermission).length
            ? teamPermission?.Team?.includes("team:share-playlist")
          ...
          <>
            {(Object.keys(teamPermission).length
              ? teamPermission?.Team?.includes("team:publish-playlist")
              : permission?.Playlist?.includes("playlist:publish")) && (
              <ShareLink
...
const mapDispatchToProps = (dispatch) => ({
  ...
  enablePlaylistShared: (projectId, playlistId) =>
    dispatch(enablePlaylistShare(projectId, playlistId)),
});
