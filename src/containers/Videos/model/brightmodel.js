  ...
  return (
    ...
    >
      ...
      >
        ...
        <HeadingTwo
          text={`Add videos from ${platformName}`}
          color="#515151"
        ...
        <div>
          ...
          >
            <Row className="video-model-tab-row">
              ...
              <Col
                className="detail-permission-tab"
                sm={showSidebar ? 9 : 12}
              >
                <br />
                        ...
                        <input
                          ...
                          placeholder={
                            platformName == "Komodo"
                              ...
                              : "Search by video name or video id..."
                          }
                        />
                        <button
                          onClick={async () => {
